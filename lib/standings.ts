 ...
 * VA State Champions (top Virginia finisher) are recognized on the results
 * page but weren't given prizes at VSYC-26, so they get the regular
 * competitor survey, not the winner one.
 */
